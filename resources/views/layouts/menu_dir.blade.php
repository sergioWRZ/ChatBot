<ul class="sidebar-menu">
  ...
  <li id="escuela" class="treeview">
    ...
    <ul class="treeview-menu">
      ...
      <li id="usuario"><a href="#">
          <i id="i_usuraio" class="fa fa-user"></i> Usuarios</a></li>
    </ul>
  </li>
  ...
  <li id="chat1" class="treeview">
    ...
    <ul class="treeview-menu">
      <li id="chatbot1"><a href="#"><i id="i_chatbot1" class="fa fa-comments"></i> Chatbot</a></li>
      <li id="registro1"><a href="#"><i id="i_registro1" class="fa fa-commenting"></i> Registros</a></li>
    </ul>
  </li>
